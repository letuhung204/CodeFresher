          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Student Header Table</h3>
				
			 
               <div class="button" style="width:200px;float:left">
               
               <button type="button" class="btn btn-block btn-outline-success btn-lg" style="width: 150px;"><a href="/form/student" >Add Student</a></button>
               </div>
